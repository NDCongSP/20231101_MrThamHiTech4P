/* JavaScript Virtual Keyboard, version 2.4
 *
...
VKeyboard.prototype = {
                       ...
                       do_gap, start_layout_index)
  {
    ...
    if(!exists || changed)
    {
	  ...
	  var kb_Ctrl = this._setup_key(kb_main, "___ctrl", this._findY(key)+this._findW(key), this._findW(kb_alt_gr), vcell, cp, l, lh, fs, n, pad);
      kb_Ctrl.innerHTML = "";
      this.mod[14] = kb_Ctrl;

      prevX = this._findX(kb_Ctrl), prevW = this._findW(kb_Ctrl), prevY = this._findY(kb_Ctrl);
      ...
      var kb_Ctrl_r = this._setup_key(kb_main, "___ctrl_r", prevY+gap+prevH, (this._findX(kb_alt_gr) + this._findW(kb_alt_gr))+ gap, vcell, cp, c, lh, parseFloat(fs) * 0.786, n);
      kb_Ctrl_r.innerHTML = "";
      this.mod[15] = kb_Ctrl_r;
      
      var kb_Cancel = this._setup_key(kb_main, "___Cancel", prevY+gap+prevH, (this._findX(kb_alt_gr) + this._findW(kb_alt_gr)+this._findW(kb_alt_gr)+this._findW(kb_alt_gr))+ gap, dcell, cp, c, lh, fs, n);
      kb_Cancel.innerHTML = "Cancel";
      this.mod[16] = kb_Cancel;
  ...
  _refresh_layout: function(layout)
  {
    ...
    var arr_type = this.AltGr ? (this.Shift ? "alt_gr_shift" : "alt_gr") : (this.Shift ? "shift" : (this.Ctrl?"ctrl":(this.Caps ? "caps" : "normal")));
    ...
    var ctrl_arr  = this[layout + "_ctrl"];
    ...
    var bctrl  = (ctrl_arr  && (ctrl_arr.length      == nkeys));

    var caps = this.mod[2], shift = this.mod[5], shift_r = this.mod[6], alt_gr = this.mod[11],ctrl = this.mod[14],ctrl_r = this.mod[15];
    ...
    else
    {
      ...
      this._set_key_state(ctrl_r, false, ibc, ibc, ikc);
    ...
    while((i-=1) >= 0)
    {
      ...
      else
      {
        ...
        if(key_val != "")
        {
          if(dead_arr)
          {
            for(var j = 0, l = dead_arr.length; j < l; j+=1) { var dk = dead_arr[j]; if(dk[0] == key_val) { key_val = dk[1]; break;}};
  ...
  _generic_callback_proc: function(event)
  {
    ...
    else
    {
      ...
      if(vkb.AltGr || vkb.Shift || vkb.Ctrl || r)
      {
        vkb.AltGr = false; vkb.Shift = false;vkb.Ctrl = false;
        vkb._refresh_layout();
      }
    }
  ...
  De_ctrl: [["&#x005E;", "Circumflex"], "&#x0031;", "&#x0032;", "&#x0033;", "&#x0034;", "&#x0035;", "&#x0036;", "&#x0037;", "&#x0038;", "&#x0039;", "&#x0030;", "&#x00DF;", ["&#x00B4;", "Acute"],
               , , "&#x0065;", , , , , , , , "&#x00FC;", "&#x002B;", "&#x003C;",
               "&#x0061;", , "&#x0064;", , , , , , , "&#x00F6;", "&#x00E4;", "&#x0023;",
               , , "&#x0063;", , "&#x0062;", , , "&#x002C;", "&#x002E;", "&#x002D;"],
  // French:
  ...
  Cz_ctrl: ["&#x003B;", "&#x002B;", "&#x011B;", "&#x0161;", "&#x010D;", "&#x0159;", "&#x017E;", "&#x00FD;", "&#x00E1;", "&#x00ED;", "&#x00E9;", "&#x003D;", ["&#x00B4;", "Acute"],
              , , "&#x0065;", , , , , , , , "&#x00FA;", "&#x0029;", "&#x0026;",
              "&#x0061;", , "&#x0064;", , , , , , , "&#x016F;", "&#x00A7;", ["&#x00A8;", "Umlaut"],
              , , "&#x0063;", , "&#x0062;", , , "&#x002C;", "&#x002E;", "&#x002D;"],
  // Greek:
