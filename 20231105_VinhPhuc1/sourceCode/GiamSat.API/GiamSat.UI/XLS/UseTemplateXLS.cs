...
namespace GiamSat.UI
{
    public class UseTemplateXLS
    {
        ...
        public byte[] Edition(Stream streamTemplate, List<DataLogModel> data)
        {
        ...
        public async Task<byte[]> FillIn(HttpClient client, Stream streamTemplate, List<DataLogModel> data, string existingXLS)
        {
            // Open the Templace
            var template = new XLTemplate(streamTemplate);
            // Send Data
